...
//    gl.bindVertexArray(frameVertexArray);
    ...
    const draw = () => {
        ...
        time_loc = gl.getUniformLocation(ShaderProgram, "Zoom");
        gl.uniform1f(time_loc, Zoom);

        time_loc = gl.getUniformLocation(ShaderProgram, "dX");
        gl.uniform1f(time_loc, xDelta);

        time_loc = gl.getUniformLocation(ShaderProgram, "dY");
        gl.uniform1f(time_loc, yDelta);
